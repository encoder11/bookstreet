  ...
  <section id="container">
    ...
    <section id="main-content">
      ...
      <table width=99%>
         <tr>
            <td>
               <h3><i class="fa fa-angle-right"></i> 거래 내역</h3>
            <td align=right>
               <button type="button" class="btn btn-theme04" onclick="shortcut();"><i class="fa fa-edit"></i> 출고 현황</button>
      </table>
        <div class="row">
          <div class="col-md-12">
      ...
      <form name="corpSearchForm" method="post" action="/group4erp/viewTranSpecList.do">
         ...
         <table class="searchTable" style="border: 0px;">
            <tr>
                  <th width="8%"style="text-align:right;"><b>* 발급 여부&nbsp;</b></th>
                  <td width="13%" align=left>
                     <input type="checkbox" name="issueYn" value="y">발급
                     <input type="checkbox" name="issueYn" value="n">미발급
          ...
          <div class="col-md-12 mt">
            ...
            <table border=0 width=98%>
               <tr>
                  ...
                  <td align=right>[전체] : ${corp_tran_cnt} 건
