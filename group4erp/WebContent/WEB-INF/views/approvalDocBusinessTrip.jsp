	...
	<form class="BTripApprovalDoc" method="post">
		...
		<tr>
			<table class="documentTable searchTable tableth" name="documentTable" cellpadding=5" cellspacing="5" width="50%">		
				<tr>
					<th width="100">신청번호</td><td colspan="3">${myBTripApplyInfo.work_outside_seq}
															<input type="hidden" name="document_no" value="${myBTripApplyInfo.work_outside_seq}">
					</td>
				</tr>
				<tr>
					<th width="100">기안자</td><td widht="200">직급 : ${myBTripApplyInfo.jikup}&nbsp;  </td><td width="200" >성명 : ${myBTripApplyInfo.emp_name}  </td>
				</tr>
				<!-- <tr>
					<td width="100">신청 휴가</td ><td colspan="3">${myDayOffApplyInfo.dayoff_category}</td>
				</tr>	 -->		
				<tr>
					<th>출장 기간</td><td colspan="2">${myBTripApplyInfo.outside_start_time} ~ ${myBTripApplyInfo.outside_end_time} </td>
				</tr>
				<tr>
					<th>목적지</td><td colspan="2">${myBTripApplyInfo.destination}</td>
				</tr>
				<tr>
					<th>사유</td><td colspan="2">${myBTripApplyInfo.work_outside_reason}</td>
				</tr>
				<tr>
